...
namespace AnhCF
{
    internal class Constants
    {
        ...
        public static string YOU_WANNA_DELETE_BAN = "Bàn có muốn xóa bàn";

        public static string DELETE_BAN_FAILED = "Xoá bàn không thành công";

        public static string DELETE_BAN_SUCCESSFUL = "Xóa bàn thành công";

        public static string PLS_SELECT_BAN_TO_DELETE = "Vui lòng chọn bàn để xóa";
        ...
        public static string REPORT_DT_EmbeddedResource_PHIEUHD = "ANHCF.rptPhieuHoaDon.rdlc";
        ...
        public static string REPORT_DT_EmbeddedResource_MONTH = "ANHCF.rptDoanhThuTheoThang.rdlc";
        ...
        public static string REPORT_DT_EmbeddedResource_TO_DAY_FROM_DAY = "ANHCF.rptDoanhThuTuNgayDenNgay.rdlc";
        ...
        public static string REPORT_DT_EmbeddedResource_ALL_SP = "ANHCF.rptTatCaSanPham.rdlc";
        public static string REPORT_DT_DataSources_ALL_SP = "DSSanPham";

        public static string REPORT_DT_EmbeddedResource_SP_GROUP = "ANHCF.rptNhomSanPham.rdlc";
        ...
        public static string REPORT_DT_EmbeddedResource_LOAISP = "ANHCF.rptSanPhamTheoLoai.rdlc";
        ...
        public static string REPORT_DT_EmbeddedResource_SELL_S = "ANHCF.rptSanPhamDuocMuaChart.rdlc";
        public static string REPORT_DT_DataSources_SELL = "DSCTHDSanPham";

        public static string REPORT_DT_EmbeddedResource_CHUCVU = "ANHCF.rptNhanVienTheoChucVu.rdlc";
